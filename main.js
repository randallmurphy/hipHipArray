...
const newSymmetricalCapitals = symmetricalCapitals.splice(9);
console.log(newSymmetricalCapitals)
for(let i = 0; i < newSymmetricalCapitals.length; i++){
  console.log(newSymmetricalCapitals[i]);
}

// Challenge 6
// Add two values (of your choice) to the end and then console.log out each value individually.
const fibonacciNumbers = [1, 1, 2, 3, 5, 8, 13];
fibonacciNumbers.push(3,4);
...
const myArr = ['birds','bees','summer','geese','ducks',7];
...
const empArr = [];
empArr.push('laptop','tablet','desktop');
empArr.unshift('tcl','lenovo');
console.log(empArr);
...
const dinoCopy = dinosaurs.splice(4,3);
for(let i = 0; i < dinoCopy.length;i++){
  console.log(dinoCopy[i]);
}

// Challenge 13
// Use .join to change the dinosaur strings from the above array into one string with a '*' string as the "separator". Then console.log out that string.
const dinosaurStrings = dinosaurs.join('*');
  console.log(dinosaurStrings);
